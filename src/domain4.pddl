...
(:predicates (loaded ?g - box ?t - robot ?l - level)
	     ...
	     (ready-to-offload ?g - box ?m -  room ?l - level)
	     (next ?l1 ?l2 - level)
	     (at ?t - robot ?p - place)
...
(:action locate-box
 ...
 :precondition (and (at ?t ?m) (ready-to-offload ?g ?m ?l2) (ready-to-load ?g ?m ?l3)
		    (next ?l2 ?l1) (next ?l4 ?l3))
 :effect (and (ready-to-offload ?g ?m ?l1) (not (ready-to-offload ?g ?m ?l2)) 
